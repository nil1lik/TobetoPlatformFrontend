...
export const userFirstnameMaxLength = 30;
export const userFirstnameMaxLengthMessage = "İsim maksimum 30 karakter olmalıdır.";

export const userLastnameMinLengthMessage = "Soyisim minimum 2 karakter olmalıdır.";
