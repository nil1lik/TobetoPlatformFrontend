...
import "./calendar.css";
import { GetInstructorItem } from "../../models/responses/instructor/getInstructorResponse";
import instructorService from "../../services/instructorService";
import {
  EducationStatusText,
  calendarDropboxLabel,
  calendarDropboxPlaceholderText,
        ...
        <Col xs={3}>
          <div className="filter-left equal-box">
            <div className="d-flex flex-column">
              ...
              <SearchBar
                searchBoxClassName="calendar-search-box"
                formClassName="calendar-form-control mr-sm-2"
              />
              {/* <input
                type="text"
            ...
            <div className="d-flex flex-column">
              ...
              <Dropdown className=" calender-select dropdown-calendar">
                <Dropdown.Toggle
                  variant="success"
                  id="dropdown-basic"
                  className="btn-calendar dropdown-toggle-calendar"
                >
                  <div className="css-14cgata-control">
                    <div className="css-hlgwow">
                      <div className="css-1jqq78npmo-placeholder">
                        {calendarDropboxPlaceholderText}
                      </div>
                    </div>
                ...
                <Dropdown.Menu className="dropdown-menu-calendar">
                  {instructor.map((instructor) => (
                    <Dropdown.Item
                      className="dropdown-item insturctor-dropdown-calendar"
                      eventKey={instructor.id}
                    >{`${instructor.firstName} ${instructor.lastName}`}</Dropdown.Item>
                  ))}
                </Dropdown.Menu>
              </Dropdown>
            </div>
            <div className="d-flex flex-column">
              <label className="label-header">
                {EducationStatusText.checkboxesHeader}
              </label>
