/* COMMON VALUES */
export const readMoreText = "Devamını oku";
export const showMoreText = "Daha Fazla Göster";
export const startButtonText = "Başla";
...
export const SocialMediaAccountUpdateSuccess = "Sosyal Medya Hesabınız Başarıyla Güncellendi";